{
  # Frozen workspace for the double_pendulum one-shot example.
  #
  # The ranim rev below must match the rev in Cargo.toml; CI checks that
  # Cargo.toml, this file and flake.lock all agree.
  description =
    "double_pendulum — deterministic chaos from a 0.001 rad difference (frozen one-shot ranim example)";
